...
class MainActivity : AppCompatActivity() {
    ...
    private val mModelPath = "mask_detector.tflite"     // MSc project\FaceMaskDetector-Android-master\app\src\main\assets
    private val mLabelPath = "label.txt"                // MSc project\FaceMaskDetector-Android-master\app\src\main\assets
    private val mSamplePath = "image.png"               // MSc project\FaceMaskDetector-Android-master\app\src\main\assets
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnPredict.setOnClickListener {
            ...
            val mailBtn = dialog.findViewById(R.id.mailBtn) as Button
            ...
            if(results?.title == "No Mask"){
                ...
                fun composeEmail(subject: String, text: String) {
                ...
                mailBtn.setOnClickListener { composeEmail(
                    title as String, text = "No Mask"
                )}
